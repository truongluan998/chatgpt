...
class __$$SubmittingCopyWithImpl<$Res>
    extends _$AuthenticationStateCopyWithImpl<$Res, _$Submitting>
...
class _$Submitting implements Submitting {
  ...
  @override
  String toString() {
    return 'AuthenticationState.submitting()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$Submitting);
  }
...
abstract class Submitting implements AuthenticationState {
